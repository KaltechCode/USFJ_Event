...
This is a standalone Next.js/React/TypeScript version of the invitation, with the supplied portrait, updated event schedule, envelope animation, volunteer/guest/sponsor registration forms, personalized confirmation, calendar download and organizer dashboard.

- Runtime: Node.js 22 on ScalaHosting VPS, behind an HTTPS reverse proxy.
- Data: Supabase PostgreSQL; migrations in supabase/001_initial.sql and supabase/002_registration_forms.sql.
